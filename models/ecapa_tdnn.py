...
class ECAPA_TDNN(nn.Module):
    ...
    def __init__(self, C=512, exp_config = config.ExpConfig()):

        super(ECAPA_TDNN, self).__init__()

        self.conv1  = nn.Conv1d(exp_config.n_mels, C, kernel_size=5, stride=1, padding=2)
        self.relu   = nn.ReLU()
        ...
        self.fc6 = nn.Linear(3072, exp_config.embedding_size)
        self.bn6 = nn.BatchNorm1d(exp_config.embedding_size)
...
if __name__ == "__main__":
    ...
    model = ECAPA_TDNN(512).cuda()
    
    #summary(model, (int(3.2*16000)))
